---
summary: '<p>The two intuitive steps, written out precisely.</p><span class="toc-summary__sub">Key ideas</span><p class="toc-summary__chips">vectors with the same dimension · squared distance · average · eliminate · randomly reinitialize · aren&#x27;t</p>'
---
# K-means Algorithm
